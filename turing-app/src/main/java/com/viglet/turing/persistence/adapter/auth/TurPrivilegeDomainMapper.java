...
/**
 * MapStruct mapper for the JPA {@link TurPrivilege} entity to the
 * {@link TurPrivilegeDomain} aggregate.
 *
 * @author Alexandre Oliveira
 * @since 2026.2.6
 */
@Mapper(componentModel = "spring")
public interface TurPrivilegeDomainMapper {

    @Mapping(target = "roleIds", source = "turRoles")
    TurPrivilegeDomain toDomain(TurPrivilege entity);

    List<TurPrivilegeDomain> toDomainList(List<TurPrivilege> entities);
