 ...
 * <li>{@link #getTokenType(List, String)}: Determines the token type
 * of a given token.</li>
 * </ul>
 *
...
public class TurSNSuggestionAutomaton {
    ...
    public boolean isAddSuggestion(String suggestion, int numberOfWordsFromQuery, List<String> stopWords) {
        final Deque<String> tokensDeque = prepareNewSuggestionTokens(suggestion, numberOfWordsFromQuery, stopWords);
    ...
    @Nullable
    private static Deque<String> prepareNewSuggestionTokens(String suggestion, int numberOfWordsFromQuery,
