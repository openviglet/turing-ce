...
public class TurLocaleOnStartup {
	...
	public void createDefaultRows() {
		...
		if (turLocaleRepository.findAll().isEmpty()) {
			...
			turLocaleRepository
					.save(new TurLocale(LocaleUtils.toLocale("da"), "Dansk - Danish", "Dansk - Dinamarquês"));
			...
			turLocaleRepository
					.save(new TurLocale(LocaleUtils.toLocale("es"), "Español - Spanish", "Español - Espanhol"));
			...
			turLocaleRepository
					.save(new TurLocale(LocaleUtils.toLocale("ga"), "Gaeilge - Irish", "Gaeilge - Irlandês"));
			turLocaleRepository.save(new TurLocale(LocaleUtils.toLocale("gl"), "Galego - Galician", "Galego"));
			turLocaleRepository
					.save(new TurLocale(LocaleUtils.toLocale("gu"), "ગુજરાતી - Gujarati", "ગુજરાતી - Guzerate"));
			turLocaleRepository
					.save(new TurLocale(LocaleUtils.toLocale("he"), "עִבְרִית - Hebrew", "עִבְרִית - Hebraico"));
			turLocaleRepository.save(new TurLocale(LocaleUtils.toLocale("hi"), "िन्दी - Hindi", "िन्दी - Híndi"));
			turLocaleRepository
					.save(new TurLocale(LocaleUtils.toLocale("hu"), "Magyar - Hungarian", "Magyar - Húngaro"));
			turLocaleRepository
					.save(new TurLocale(LocaleUtils.toLocale("id"), "Bahasa Indonesia - Indonesian",
			...
			turLocaleRepository.save(
					new TurLocale(LocaleUtils.toLocale("msa"), "Bahasa Melayu - Malay", "Bahasa Melayu - Malaio"));
			turLocaleRepository
					.save(new TurLocale(LocaleUtils.toLocale("nl"), "Nederlands - Dutch", "Nederlands - Holandês"));
			turLocaleRepository
					.save(new TurLocale(LocaleUtils.toLocale("no"), "Norsk - Norwegian", "Norsk - Norueguês"));
			...
			turLocaleRepository
					.save(new TurLocale(LocaleUtils.toLocale("pt_PT"), "Português - Portuguese (Portugal)",
							"Português (Portugal)"));
			turLocaleRepository.save(
					new TurLocale(LocaleUtils.toLocale(TurLocaleRepository.PT_BR), "Português - Portuguese (Brazil)",
							"Português (Brasil)"));
			...
			turLocaleRepository
					.save(new TurLocale(LocaleUtils.toLocale("th"), "ภาษาไทย - Thai", "ภาษาไทย - Tailandês"));
			turLocaleRepository.save(new TurLocale(LocaleUtils.toLocale("tr"), "Türkçe - Turkish", "Türkçe - Turco"));
			turLocaleRepository.save(new TurLocale(LocaleUtils.toLocale("uk"), "Українська мова - Ukrainian",
					"Українська мова - Ucraniano"));
			turLocaleRepository.save(new TurLocale(LocaleUtils.toLocale("ur"), "اردو - Urdu", "اردو - Urdu"));
			turLocaleRepository.save(
					new TurLocale(LocaleUtils.toLocale("vi"), "Tiếng Việt - Vietnamese", "Tiếng Việt - Vietnamita"));
			turLocaleRepository
					.save(new TurLocale(LocaleUtils.toLocale("xx_LC"), "LOLCATZ - Lolcat", "LOLCATZ - Lolcat"));
			turLocaleRepository.save(new TurLocale(LocaleUtils.toLocale("zh"), "Chinese", "Chinês"));
			turLocaleRepository.save(new TurLocale(LocaleUtils.toLocale("zh_CN"), "简体中文 - Simplified Chinese",
					"简体中文 - Chinês simplificado"));
			turLocaleRepository.save(new TurLocale(LocaleUtils.toLocale("zh_TW"), "简体中文 - Traditional Chinese",
